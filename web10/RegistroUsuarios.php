...
echo "<table width='80%'>";
  ...
  if ($filas==0){
    ...
    $registrousuarios= mysqli_query($conexion, "INSERT INTO usuarios (id_lista, red_social, usuario, bio, seguidores, texto, id_str, web, fecha, comunicacion) VALUES ('$idlista', $redSocial', $idTwitter', '$descripcion', '$followers', '$text', '$idStr', '$web', '$fecha', 'no')") or die ('Error en la conexión con la tabla usuarios'.mysqli_connect_errno());
