...
<div class="row wrapper-menu">
		...
		<div class="col-md-12 animacion1">
...
<div class="row">
         ...
         <div class="header-1 col-xs-7 col-sm-12 col-md-12 col-md-offset-6" >También puedes buscar <br>una lista ya creada<form action="listas.php" method="post"> <br><input placeholder="Buscar..." type="search" name="buscar"><br><button type="submit" name="buscar">ENVIAR</button></form></div>
	  	<?php
